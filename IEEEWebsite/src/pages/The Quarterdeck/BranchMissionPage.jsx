...
const BranchMissionPage = () => {
  return (
    <div className="h-auto flex flex-col items-center justify-start px-[15%] py-20 ">
      ...
      <h1 className="text-4xl font-extrabold mb-4">BRANCH MISSION</h1>
      ...
      <div className="text-start">
        ...
        <ul className="list-disc list-inside marker:text-IEEE-Orange text-2xl space-y-2">
        ...
        <p className="font-normal text-2xl mt-10 text-Text-Grey">
